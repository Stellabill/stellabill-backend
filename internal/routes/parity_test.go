...
var exemptedRoutes = map[string]map[string]string{
	"GET": {
		...
		"/api/admin/feature-flags":   "Internal admin feature flags endpoint, operational use only",
		"/api/metrics":               "Internal Prometheus metrics endpoint, not part of public API",
	},
	"POST": {
