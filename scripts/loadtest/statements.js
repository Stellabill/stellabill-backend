...
export function setup() {
  const res = http.get(`${target}/api/v1/statements`, { headers, tags: { endpoint: 'statements', phase: 'warmup' } });
  const ok = check(res, {
...
export default function () {
  const res = http.get(`${target}/api/v1/statements`, { headers, tags: { endpoint: 'statements' } });
